    ...
    <div className="table-responsive py-3">
      <table className="table table-sm ">
        <thead className="table-light">
          <tr>
            <th scope="col" className="text-center">Iniciar</th>
        ...
        <tbody>
          {partidos.map((objeto, index) => (
            <tr key={index}>
              ...
              <td className="text-start align-middle">{formatDateTime(objeto.dateTime)}</td>
              <td className="text-start align-middle">{objeto.place}</td>
              <td className="text-start align-middle">{objeto.home.club.name}</td>
              <td className="text-start align-middle">{objeto.away.club.name}</td>
